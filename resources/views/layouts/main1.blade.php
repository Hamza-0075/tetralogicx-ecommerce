...
<body>
    ...
    <!-- Libs JS -->
    <script src="{{ asset('backend/dist/libs/apexcharts/apexcharts.min.js') }}" defer></script>
    <script src="{{ asset('backend/dist/libs/jsvectormap/dist/js/jsvectormap.min.js') }}" defer></script>
    <script src="{{ url('backend/dist/libs/jsvectormap/dist/maps/world.js') }}" defer></script>
    <script src="{{ url('backend/dist/libs/jsvectormap/dist/maps/world-merc.js') }}" defer></script>
    <!-- Tabler Core -->
    <script src="{{ url('backend/dist/js/tabler.min.js7') }}" defer></script>
    <script src="{{ url('backend/dist/js/demo.min.js') }}" defer></script>
