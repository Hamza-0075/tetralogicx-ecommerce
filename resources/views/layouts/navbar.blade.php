            ...
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                {{-- <li class="nav-item dropdown">
                  <a class="nav-link" href="#navbar-base" role="button" aria-expanded="false" >
                ...
                @can('user management')
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{route('users')}}" rel="noopener">
                        Users
                        </a>
                        {{-- <a class="dropdown-item" href="./changelog.html">
                        Users List
                        </a> --}}
                        <a href="{{route('roles')}}" class="dropdown-item" href="https://github.com/tabler/tabler" rel="noopener">
                        Roles
                        </a>
                        <a class="dropdown-item" href="{{route('permissions')}}"  rel="noopener">
                            Permissions
                        </a>
