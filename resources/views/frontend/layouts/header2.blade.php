        ...
        <div class="wrap-menu-desktop how-shadow1">
            <nav class="limiter-menu-desktop container">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        <li {{ request()->routeIs('/') ? 'active-menu ' : '' }}>
                            <a href="{{route('home')}}">Home</a>
                        </li>

                        <li {{ request()->routeIs('shop.products') ? 'active-menu ' : '' }}>
                ...
                <div class="wrap-icon-header flex-w flex-r-m">
                    ...
                    <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart countItem" data-notify="0">
